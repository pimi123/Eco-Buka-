...
<template>
  <WebsiteLayout>
    <section v-if="product" class="container-shell grid gap-8 py-10 sm:py-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
      ...
      <div class="min-w-0">
        ...
        <div class="mt-8 flex flex-col gap-3 min-[420px]:flex-row min-[420px]:flex-wrap">
    ...
    <section v-if="product" class="container-shell pb-10 sm:pb-14">
